            ...
            {!isSessionActive ? (
              <div className="flex flex-col items-center justify-center h-full space-y-6 text-center">
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-lg font-medium text-sm text-white shadow-lg
                    transition-all active:scale-95 bg-blue-600 hover:bg-blue-700 shadow-blue-500/20"
                >
                  Start New Session
                </button>
                ...
                <div className="w-full pt-4 border-t border-gray-200 dark:border-[#333]">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button 
                      ...
                      className="px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded text-sm font-medium
                        hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors disabled:opacity-40"
                    >
                      Join
                    </button>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <button 
                  ...
                  className="w-full mt-4 py-2 text-xs font-medium text-red-500
                    hover:bg-red-500/10 border border-red-500/20 rounded-lg transition-colors"
                >
                  End Session
                </button>
              </div>
